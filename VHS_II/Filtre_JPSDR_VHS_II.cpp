...
public:
	JPSDR_VHS_II(){}
	JPSDR_VHS_II(const JPSDR_VHS_II& a)
	{
		mData=a.mData;
		InternalInit();
	}
...
void JPSDR_VHS_II::InternalInit(void)
{
	int16_t i,j;
...
VDXVideoFilterDefinition<JPSDR_VHS_II>("JPSDR","VHS II v2.3.5","Filter to remove VHS noise [lag 2].");
