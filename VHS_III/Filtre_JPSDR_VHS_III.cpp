...
/*		case nsVDXPixmap::kPixFormat_VDXA_RGB :
	...
	return(FILTERPARAM_SUPPORTS_ALTFORMATS|FILTERPARAM_HAS_LAG(2));
}
...
void JPSDR_VHS_III::Run()
{
	...
	src_Y=src;
	dst_Y=dst;
	src_U=idata.src_plane1;
	dst_U=idata.dst_plane1;
	src_V=idata.src_plane2;
...
void JPSDR_VHS_III::Start()
{
	...
	switch(idata.video_mode)
	{
		case 0 :
		case 1 :
			size_Y=(idata.src_h0*idata.src_w0)*sizeof(int16_t);
			size_U=(idata.src_h0*idata.src_w0)*sizeof(int16_t);
			size_V=(idata.src_h0*idata.src_w0)*sizeof(int16_t);
			break;
		case 2 :
		case 3 :
			size_Y=(idata.src_h0*2*((idata.src_w0+1)>>1))*sizeof(int16_t);
			size_U=(idata.src_h0*((idata.src_w0+1)>>1))*sizeof(int16_t);
			size_V=(idata.src_h0*((idata.src_w0+1)>>1))*sizeof(int16_t);
			break;
		case 4 :
		case 5 :
		case 6 :
		...
		case 8 :
			size_Y=(idata.src_h0*idata.src_w0)*sizeof(int16_t);
			size_U=(idata.src_h1*idata.src_w1)*sizeof(int16_t);
			size_V=(idata.src_h2*idata.src_w2)*sizeof(int16_t);
			break;
	}
