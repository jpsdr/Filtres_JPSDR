...
void JPSDR_ColorSpaceConvert::Start()
{
	...
	if  ( mData.mt_mode && (idata.src_h0>=32) && (idata.dst_h0>=32) &&
		...
		(mData.full_range_in!=mData.full_range_out)) ) threads_number=CPUs_number;
...
VDXVideoFilterDefinition<JPSDR_ColorSpaceConvert>("JPSDR","Color Space Convert v2.0.0","YCbCr color space convertion.\n[ASM][SSE2] Optimised.");
